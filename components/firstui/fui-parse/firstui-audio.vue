		...
		methods: {
			handleInitAudio(src) {
				...
				this.innerAudioContext.onCanplay(() => {
					...
					const _fui_duration = this.innerAudioContext.duration;
					setTimeout(() => {
